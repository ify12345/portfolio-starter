        ...
        <div className="flex flex-col  gap-y-10 lg:flex-row">
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            <motion.p
             ...
             initial='hidden'
             whileInView={'show'}
             viewport={{once: false, amount: 0.7}} className="mb-8 max-w-3xl  mx-auto lg:mx-0">
              I build accessible, inclusive products and digital experiences for the web. And
              code beautifully simple things,Your friendly neighborhood frontend developer and JavaScript engineer <Link to="contact"> CONTACT ME</Link>
            </motion.p>
            <motion.div 
             variants={fadeIn('up', 0.5)}
             initial='hidden'
             ...
             viewport={{once: false, amount: 0.7}}className="flex max-w-max gap-x-6 items-center mb-12 mx-auto lg:mx-0">
              <Link to='about' className="btn btn-lg flex items-center gap-x-6 cursor-pointer">See More About me  <div className={`icon-container ${isHovered ? 'hovered' : ''}`}
          ...
          <motion.div 
           ...
           initial='hidden'
           whileInView={'show'}
           viewport={{once: false, amount: 0.7}}className="hidden lg:flex lg:max-w-[482px]">
            {/* <img src={} alt="img"></img> */}
