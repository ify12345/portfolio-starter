...
const About = () => {
  return (
    <section className="h-screen py-20 " id="about">
      <div className="container mx-auto h-screen grid grid-row-2 ">
        <div className="">
          ...
          >
            <div className="w-[50%] flex flex-col gap-4">
              <h1 className="text-4xl">NWAKODO IFEANYI</h1>
              <h1>Front End Developer / JavaScript Fan / React developer</h1>
            </div>
            <div className="w-[50%]">
              Professionally connected with the web development industry. I have
              spent the past years Tutoring aspiring web developers on the
              basics of web devlopment and done a little{" "}
              <Link to="">projects</Link> for my self . Problem solver,
              well-organised person, loyal employee with high attention to
              detail. Fan of Soccer, Music Production, video games, and coding
              of course. Interested in the entire frontend spectrum and working
        ...
        <div className="flex flex-col gap-8 mt-[-100px]">
          ...
          >
            ...
            with React and React Native, custom plugins, features, animations,
